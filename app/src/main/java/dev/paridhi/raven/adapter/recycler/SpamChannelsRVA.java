...
public class SpamChannelsRVA extends FirestoreRecyclerAdapter<ChannelModel, SpamChannelsRVA.ChannelHolder > {
    ...
    public SpamChannelsRVA(@NonNull FirestoreRecyclerOptions<ChannelModel> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull SpamChannelsRVA.ChannelHolder holder, int position, @NonNull ChannelModel model) {

        try {
            holder.mLastMessage.setText(model.getLastSpamMessage());
    ...
    @NonNull
    @Override
    public SpamChannelsRVA.ChannelHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void setOnItemClickListener(SpamChannelsRVA.OnItemClickListener listener){
